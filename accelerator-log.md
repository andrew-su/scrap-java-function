...
```json
{
  "buildType" : "maven",
  "gitBranch" : "main",
  "gitUrl" : "https://github.com/andrew-su/scrap-java-functions.git",
  "includeTap" : true,
  "interfaceType" : "http",
  "projectName" : "scrap-java-function"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [https://github.com/sample-accelerators/java-functions-accelerator.git->https://github.com/a...(truncated), main->main]
